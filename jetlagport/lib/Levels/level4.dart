...
import '../Transitions/transition4.dart';

void main() async {
  print('test print function');
  runApp(GameWidget(game: Level4()));
}

class Level4 extends BaseGame with HasDraggableComponents, HasCollidables {
  bool running = true;
  Greenball gb1;
  Greenball gb2;
  ...
  Future<void> onLoad() async {
    ...
    add(background);
    final greenball1 = Greenball(Vector2(10, 10), true);
    final greenball2 = Greenball(Vector2(10, 90), true);

    final mustardball1 = Mustardball(Vector2(500, 240), 4);
    final mustardball2 = Mustardball(Vector2(500, 30), 4);
    ...
    mustardball2..sprite = await loadSprite('mustardball.png');
