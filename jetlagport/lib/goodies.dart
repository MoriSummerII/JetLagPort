...
//pass in level: indicate the level of the goodies
...
class Goodies extends PositionComponent with Hitbox, Collidable {
  bool _PlayerHit = false;
  int level, shape;
  double lengthx, heighty;
  String shapez;
  Goodies(Vector2 position, this.level, this.lengthx, this.heighty, this.shapez)
      : super(
          position: position,
